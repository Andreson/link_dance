import 'package:link_dance/components/contentGroup/content_group_form.dart';
...
class _ContentGroupState extends State<ContentGroupScreen> {
  final GlobalKey<ContentGroupFormState> formUploadKey =
      GlobalKey<ContentGroupFormState>();
